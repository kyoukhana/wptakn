				...
				if($this.find('.item-detail').length <= 0) {
					...
					{						
						...
						$('#twitter').sharrre({
							...
							template: '<div class="box" href="#"><div class="count" href="#">{total}</div><div class="share"><span class="social-twitter"></span></div></div>',
							enableHover: false,
							enableTracking: true,
							buttons: { twitter: {}},
						...
						$('#facebook').sharrre({
							...
							template: '<div class="box" href="#"><div class="count" href="#">{total}</div><div class="share"><span class="social-facebook"></span></div></div>',
							enableHover: false,
							enableTracking: true,
							click: function(api, options){
								api.simulateClick();
						...
						$('#googleplus').sharrre({
							...
							template: '<div class="box" href="#"><div class="count" href="#">{total}</div><div class="share"><span class="social-gplust"></span></div></div>',
							enableHover: false,
							enableTracking: true,
							urlCurl: '',
							click: function(api, options){
						...
						$('#pinterest').sharrre({
							...
							template: '<div class="box" href="#" rel="nofollow"><div class="count" href="#">{total}</div><div class="share"><span class="social-pinterest"></span></div></div>',
							enableHover: false,
							enableTracking: true,
							buttons: {
								pinterest: {
